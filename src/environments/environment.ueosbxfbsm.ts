...
const awsmobile = {
  ...
  //Ravi's end point!
  //"aws_appsync_graphqlEndpoint": "https://sv8qjoc201.execute-api.us-east-1.amazonaws.com/api/grs/graphql",
  "aws_appsync_graphqlEndpoint": "https://mqran6aetbacxk27xjec5ti7ry.appsync-api.us-east-1.amazonaws.com/graphql",
  "aws_appsync_region": "us-east-1",
  "aws_appsync_authenticationType": "AMAZON_COGNITO_USER_POOLS",
  "aws_cloud_logic_custom": [
      {
          "name": "grsrest",
          // "endpoint": "https://sv8qjoc201.execute-api.us-east-1.amazonaws.com/api/rest",
          "endpoint": "https://dbgpgkdey33x2.cloudfront.net/api/rest",
          "region": "us-east-1"
      }
  ]
};
